...
const doctorName = (full_name) => {
  ...
  return full_name.replace(/^Dr\.?\s*/i, '').trim();
};
      ...
      <div style={{ flex:'1', overflowY:'auto', paddingBottom:'80px' }}>
        ...
        <div style={{ background:'linear-gradient(135deg,#0A2F6E,#0D3B8A)', padding:'40px 20px 24px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
            ...
            <div onClick={() => navigate('profile')} style={{ width:'44px', height:'44px', borderRadius:'50%', background:'rgba(255,255,255,0.15)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'22px', cursor:'pointer' }}>🙋</div>
          </div>
